...
const projectsData: Project[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    liveUrl: 'https://smit-thakkar.github.io/', // Updated live URL
    repoUrl: 'https://github.com/Encrypt3dM1nd/smit-thakkar.github.io', // Updated repo URL
    ...
    <div className="animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
       ...
       <p className="text-center text-slate-600 mt-12">
        More projects and details available on my <a href="https://github.com/Encrypt3dM1nd" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:underline font-semibold">GitHub profile</a>.
      </p>
    </div>
  );
};
